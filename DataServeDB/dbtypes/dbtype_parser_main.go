...
func lex(s string) []parsers.Token {
	lexerRe := regexp.MustCompile(`\.\.|!|:|\(|,|\)|\b(?:string|int32|datetime|guid|PrimaryKey|UniqueIndex|SequentialUniqueIndex|Nullable|Length|NumberRange|EmptyString|default|auto|[a-zA-Z][a-zA-Z0-9_]+|[0-9_]+)\b|(?:['].*[']|["].*["])|[^ ;]+`)
